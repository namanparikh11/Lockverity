...
export function DemoHomePage() {
  return (
    <>
      <PageHeader
        title="Local demo"
        description="A 60-second guided walkthrough of the Lockverity v2.1.3 demo. The five pages below cover every v0.5–v2.1.2 surface; the live demo is the canonical evidence."
      ...
      <div className="space-y-6">
        ...
        <section aria-labelledby="demo-commands" className="card">
          ...
          <pre className="mt-3 overflow-x-auto rounded-md border border-ink-200 bg-canvas p-3 text-xs text-ink-800"><code>{`cd backend
